...
function LoginPage() {
  ...
  return (
    <div className="min-h-screen cyber-grid-bg flex items-center justify-center px-4">
      <div className="fixed top-20 left-1/4 w-72 h-72 bg-indigo-600/20 rounded-full blur-3xl pointer-events-none" />
      <div className="fixed bottom-20 right-1/4 w-72 h-72 bg-purple-600/20 rounded-full blur-3xl pointer-events-none" />
